...
typedef enum gitem{
    ...
    high_op, low_op, factor, factor2, exprIndex, exprIndex2, arrExpr, arrExpr2, arrTerm, arrTerm2, 
    ...
    simpleStmt, program, moduleDeclarations, moduleDeclaration, otherModules, driverModule, module, if_else, if_stmt, else_stmt, else_stmts,
    ...
    WHILE, ID, NUM, RNUM, AND, OR, TRUE_, FALSE_, PLUS, MINUS, MUL, DIV, LT, LE, GE, GT, EQ, NE, HEXNUM, SIZE,
    DEF, ENDDEF, DRIVERDEF, DRIVERENDDEF, COLON, RANGEOP, SEMICOL, COMMA, ASSIGNOP, SQBO, SQBC, if_, then, else_, endif, printAncestor, subrange,
    BO, BC, COMMENT,EPS,DUMMY
}grammarItem;
...
char* grammarArr[]={
    ...
    "PRINT","USE","WITH","PARAMETERS","TAKES","INPUT","RETURNS","FOR","IN","SWITCH","CASE","BREAK","DEFAULT",
    "WHILE","ID","NUM","RNUM","AND","OR","TRUE_","FALSE_","PLUS","MINUS","MUL","DIV","LT","LE","GE","GT","EQ","NE","HEXNUM", "SIZE",
    "DEF","ENDDEF","DRIVERDEF","DRIVERENDDEF","COLON","RANGEOP","SEMICOL","COMMA","ASSIGNOP","SQBO","SQBC", "if", "then", "else", "endif", "printAncestor", "subrange",
    "BO","BC","COMMENT","EPS","DUMMY"
    };
